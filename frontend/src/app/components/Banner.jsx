...
const Banner = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden h-auto select-none"> {/* Added select-none */}
      ...
      <button
        onClick={prevSlide}
        className="hidden lg:absolute left-4 top-1/2 -translate-y-1/2 z-30 w-10 h-10 bg-white/80 rounded-full lg:flex items-center justify-center hover:bg-white transition-colors duration-300 shadow-lg"
