...
const MinimalistShopByCategory = () => {
 ...
 <div className={`grid grid-cols-2 text-center md:grid-cols-4 gap-8  `}>
   ...
   <div className=" group">
     ...
     <div className="text-2xl font-light text-[#007e44] mb-1">Purpose</div>
   ...
   <div className=" group">
     ...
     <div className="text-2xl font-light text-[#007e44] mb-1">End-to-End</div>
     <div className="text-xs tracking-wider text-gray-500 uppercase">
   ...
   <div className=" group">
     ...
     <div className="text-2xl font-light text-[#007e44] mb-1">Agile</div>
     <div className="text-xs tracking-wider text-gray-500 uppercase">
   ...
   <div className=" group">
     ...
     <div className="text-2xl font-light text-[#007e44] mb-1">Trusted</div>
     <div className="text-xs tracking-wider text-gray-500 uppercase">
