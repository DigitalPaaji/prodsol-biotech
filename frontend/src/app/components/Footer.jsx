        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-gray-800 hover:text-[#109cc7] transition-colors duration-300">
    ...
    <ul className="space-y-3">
      {section.links.map((link, index) => (
        <li key={index}>
          <Link
            href={link.href}
            className="text-gray-800 hover:text-[#109cc7] transition-all duration-300 hover:pl-2 group flex items-center"
          >
            <span className="w-1 h-1 bg-[#109cc7] rounded-full opacity-0 group-hover:opacity-100 mr-2 transition-all duration-300"></span>
            {link.name}
          </Link>
        </li>
      ))}
            ...
            <div className="flex space-x-4 mt-8">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-12 h-12 bg-black/10 rounded-xl flex items-center justify-center   hover:bg-[#109cc7] transition-all duration-300 hover:scale-110 group"
