  ...
  return (
    <section className="bg-white min-h-screen py-16 md:py-24 px-4 sm:px-6 lg:px-16 xl:px-40">
      ...
      <div className="hidden lg:flex flex-row gap-8 xl:gap-12">
        ...
        <div className="lg:w-3/4 bg-gray-50 overflow-hidden flex flex-row border border-gray-100 min-h-[600px] ">
          {/* Text Side */}
...
//   return (
//     <section className="bg-white min-h-screen py-16 md:py-24 px-4 sm:px-6 lg:px-16 xl:px-24">
//       {/* Header */}
//       <div className="mb-16 border-b border-gray-100 pb-10 text-center">
//         <h2 className="text-xs font-bold tracking-[0.3em] text-[#007e44] uppercase mb-4">Our Product Range</h2>
...
//               />
//               <div className="absolute inset-0 bg-[#007e44]/10 mix-blend-multiply" />
//               <div className="absolute bottom-4 left-4 bg-[#007e44] text-white p-2 rounded-full shadow-lg">
//                 {cat.icon}
//               </div>
//             </div>
...
//         {/* Detailed Content Canvas */}
//         <div className="lg:w-3/4 bg-gray-50 overflow-hidden flex flex-row border border-gray-100 min-h-[550px]">
//           {/* Text Side */}
...
//             <button className="mt-12 flex items-center gap-3 text-sm font-bold uppercase tracking-widest text-[#007e44] hover:gap-5 transition-all">
//               Request Formulation Details <ChevronRight className="w-4 h-4" />
//             </button>
//           </div>
...
//               src={categories[activeTab].image} 
//               alt={categories[activeTab].title} 
//               className="absolute inset-0 w-full h-full object-cover grayscale-[20%] hover:scale-110 transition-transform duration-1000"
//             />
//             <div className="absolute inset-0 bg-[#007e44]/10 mix-blend-multiply" />
//           </div>
//         </div>
